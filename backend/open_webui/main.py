...
app.state.config.update_values({
...
app.state.config.update_values({
    ...
    "ALLOWED_FILE_EXTENSIONS": RAG_ALLOWED_FILE_EXTENSIONS,
    "FILE_MAX_SIZE": RAG_FILE_MAX_SIZE,
    "FILE_MAX_COUNT": RAG_FILE_MAX_COUNT,
    "FILE_IMAGE_COMPRESSION_WIDTH": FILE_IMAGE_COMPRESSION_WIDTH,
    "FILE_IMAGE_COMPRESSION_HEIGHT": FILE_IMAGE_COMPRESSION_HEIGHT,
    ...
    "TEXT_SPLITTER": RAG_TEXT_SPLITTER,
    ...
    "RAG_AZURE_OPENAI_API_KEY": RAG_AZURE_OPENAI_API_KEY,
    "RAG_AZURE_OPENAI_API_VERSION": RAG_AZURE_OPENAI_API_VERSION,
...
app.state.config.update_values({
    "STT_ENGINE": AUDIO_STT_ENGINE,
    "STT_MODEL": AUDIO_STT_MODEL,
    "STT_SUPPORTED_CONTENT_TYPES": AUDIO_STT_SUPPORTED_CONTENT_TYPES,

    "STT_OPENAI_API_BASE_URL": AUDIO_STT_OPENAI_API_BASE_URL,
    "STT_OPENAI_API_KEY": AUDIO_STT_OPENAI_API_KEY,
    ...
    "TTS_OPENAI_API_BASE_URL": AUDIO_TTS_OPENAI_API_BASE_URL,
    "TTS_OPENAI_API_KEY": AUDIO_TTS_OPENAI_API_KEY,
    "TTS_ENGINE": AUDIO_TTS_ENGINE,
    "TTS_MODEL": AUDIO_TTS_MODEL,
    "TTS_VOICE": AUDIO_TTS_VOICE,
    "TTS_API_KEY": AUDIO_TTS_API_KEY,
    "TTS_SPLIT_ON": AUDIO_TTS_SPLIT_ON,

    "TTS_AZURE_SPEECH_REGION": AUDIO_TTS_AZURE_SPEECH_REGION,
    "TTS_AZURE_SPEECH_BASE_URL": AUDIO_TTS_AZURE_SPEECH_BASE_URL,
    "TTS_AZURE_SPEECH_OUTPUT_FORMAT": AUDIO_TTS_AZURE_SPEECH_OUTPUT_FORMAT,
})
...
async def get_app_config(request: Request):
    ...
    app.state.config.get_values(
        ["ENABLE_LDAP", "ENABLE_API_KEY", "ENABLE_SIGNUP", "ENABLE_LOGIN_FORM", "ENABLE_DIRECT_CONNECTIONS",
         "ENABLE_CHANNELS", "ENABLE_NOTES", "ENABLE_WEB_SEARCH", "ENABLE_CODE_EXECUTION", "ENABLE_CODE_INTERPRETER",
         "ENABLE_IMAGE_GENERATION", "ENABLE_AUTOCOMPLETE_GENERATION", "ENABLE_COMMUNITY_SHARING",
         "ENABLE_MESSAGE_RATING", "ENABLE_USER_WEBHOOKS", "ENABLE_GOOGLE_DRIVE_INTEGRATION",
         "ENABLE_ONEDRIVE_INTEGRATION",
         "DEFAULT_MODELS",
         "DEFAULT_PROMPT_SUGGESTIONS",
         "CODE_EXECUTION_ENGINE",
